...
export namespace VxeColumnPropTypes {
  ...
  export type SortBy<D = any> =
    | string
    | ((params: { row: D; column: VxeTableDefines.ColumnInfo<D> }) => string | number);
  ...
  export interface EditRender<D = any, P = Record<string, any>> {
    ...
    autoSelect?: boolean;
    defaultValue?:
      | ((params: { column: VxeTableDefines.ColumnInfo<D> }) => any)
      | null
      | undefined
      | string
      | number
  ...
  export type Slots<D = any> = {
    ...
    title?:
      | string
      | ((params: VxeColumnSlotTypes.HeaderSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
    ...
    radio?:
      | string
      | ((params: VxeColumnSlotTypes.RadioSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
    ...
    checkbox?:
      | string
      | ((params: VxeColumnSlotTypes.CheckboxSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
     * 自定义显示内容模板
     */
    default?:
      | string
      | ((params: VxeColumnSlotTypes.DefaultSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
     * 自定义表头内容的模板
     */
    ...
    footer?:
      | string
      | ((params: VxeColumnSlotTypes.FooterSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
    ...
    content?:
      | string
      | ((params: VxeColumnSlotTypes.ContentSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
    ...
    filter?:
      | string
      | ((params: VxeColumnSlotTypes.FilterSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
    ...
    edit?:
      | string
      | ((params: VxeColumnSlotTypes.EditSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    /**
     * 只对 edit-render 启用时有效，自定义可编辑组件模板
     */
    valid?:
      | string
      | ((params: VxeColumnSlotTypes.ValidSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
    ...
    icon?:
      | string
      | ((params: VxeColumnSlotTypes.IconSlotParams<D>) => VxeComponentSlotType[] | VxeComponentSlotType)
      | null;
  };
}
