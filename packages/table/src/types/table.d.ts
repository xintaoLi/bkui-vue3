...
export interface TablePrivateRef {
  ...
  refTooltip: Ref<unknown>;
  refValidTooltip: Ref<unknown>;
...
export interface TableMethods<DT = any> {
  ...
  getCellElement(
    row: any,
    fieldOrColumn: VxeColumnPropTypes.Field | VxeTableDefines.ColumnInfo<any> | null,
  ...
  getParentColumn(
    fieldOrColumn: VxeColumnPropTypes.Field | VxeTableDefines.ColumnInfo<any> | null,
  ): VxeTableDefines.ColumnInfo<DT> | null;
  /**
   * 获取当前表格的列
   ...
   */
  removeMergeCells(
    merges: VxeTableDefines.MergeOptions<any> | VxeTableDefines.MergeOptions<any>[],
...
export interface TablePrivateMethods<D = any> {
  ...
  saveCustomStore(
    type: 'confirm' | 'reset' | 'update:width' | 'update:fixed' | 'update:sort' | 'update:visible',
  ): Promise<any>;
...
export namespace VxeTableEvents {
  ...
  export type CheckboxChange<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CheckboxChangeEventParams<D>,
  ) => void;
  export type CheckboxAll<D = VxeTablePropTypes.Row> = (params: VxeTableDefines.CheckboxAllEventParams<D>) => void;
  export type CheckboxRangeStart<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CheckboxRangeStartEventParams<D>,
  ) => void;
  export type CheckboxRangeChange<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CheckboxRangeChangeEventParams<D>,
  ) => void;
  export type CheckboxRangeEnd<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CheckboxRangeEndEventParams<D>,
  ) => void;
  export type CheckboxRangeSelect<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CheckboxRangeSelectEventParams<D>,
  ) => void;
  ...
  export type CellMouseenter<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CellMouseenterEventParams<D>,
  ) => void;
  export type CellMouseleave<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CellMouseleaveEventParams<D>,
  ) => void;
  export type CellDeleteValue<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.CellDeleteValueEventParams<D>,
  ) => void;
  export type HeaderCellClick<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.HeaderCellClickEventParams<D>,
  ) => void;
  export type HeaderCellDblclick<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.HeaderCellDblclickEventParams<D>,
  ) => void;
  export type HeaderCellMenu<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.HeaderCellMenuEventParams<D>,
  ) => void;
  export type FooterCellClick<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.FooterCellClickEventParams<D>,
  ) => void;
  export type FooterCellDblclick<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.FooterCellDblclickEventParams<D>,
  ) => void;
  export type FooterCellMenu<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.FooterCellMenuEventParams<D>,
  ) => void;
  ...
  export type ResizableChange<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.ResizableChangeEventParams<D>,
  ) => void;
  export type ToggleRowExpand<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.ToggleRowExpandEventParams<D>,
  ) => void;
  export type ToggleTreeExpand<D = VxeTablePropTypes.Row> = (
    params: VxeTableDefines.ToggleTreeExpandEventParams<D>,
  ) => void;
