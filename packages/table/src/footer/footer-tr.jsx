...
export default {
  ...
  render() {
    const { colgroups, rowKeyFieldName, rowIndex, rowData, cellStyleOption, eventCustomOption } = this;
    ...
    const props = {
      ...
      'onDom-resize-change': this.trHeightChange,
    };

    return <VueDomResizeObserver {...props}>{getTdContent()}</VueDomResizeObserver>;
  },
};
