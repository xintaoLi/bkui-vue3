...
import { isNumber, isBoolean, isEmptyValue } from '../utils/index.js';
...
export default {
  ...
  methods: {
    ...
    bodyTdStyle() {
      ...
      if (currentColumnCollectionItem) {
        result = Object.assign(result, currentColumnCollectionItem.style);
      }
    ...
    bodyTdClass() {
      ...
      if (currentColumnCollectionItem) {
        result = Object.assign(result, currentColumnCollectionItem.class);
      }
  ...
  render(h) {
    ...
    if (eventCustomOption) {
      ...
      customEvents = bodyCellEvents ? bodyCellEvents({ row: rowData, column, rowIndex }) : {};
    }
